...
3.   게임 플레이 씬 에는 다양한 장애물, 스카이박스, 플레이어 캐릭터, 메인bgm, 배경 에셋(풀,나무),타이머 등이 배치되어있다. (3)
3-1. 게임 플레이 씬 진입시 메인 bgm이 재생된다.  (3-1)
3-2. 게임 플레이 씬 진입시 플레이어 캐릭터가 시작지점에 스폰된다. (3-2)
3-3. 게임 플레이 씬 진입시 시간이 얼마나 흘렀는지 알려주는 타이머가 가동된다. (3-3)
3-4. 게임 플레이 씬 내에는 맑은 하늘의 스카이박스가 배치되있다. (3-4)
3-5. 게임 플레이 씬 내에 아케이드 분위기에 맞게끔 꾸며져있다. (3-5)
3-6. 게임 플레이 씬 내에는 다양한 장애물들이 시작지점~골라인 까지 알맞게 배치되어있다. (3-6)
3-7. 게임 플레이 씬 진입시 각각의 효과,특성을 지닌 장애물들이 가동된다. (3-7)
3-8. 장애물의 종류에는 밟으면 날라가는 장애물, 굴러오는 장애물, 회전하는 장애물 등 다양한 방식의 장애물 구현. (3-8)
3-9. 게임 플레이 씬 스테이지 밖에는 캐릭터의 장외를 판정하는 콜라이더 구현. (3-9)
3-10. 게임 플레이 씬 스테이지 끝 에는 골라인 구현. (3-10)
4. 플레이어 캐릭터는 w / a / s / d / spacebar 키를 통해 각각 전 좌 우 후 점프 를 할수 있게끔 구현 (4)
4-1 플레이어 캐릭터는 공중에서 한번 더 점프가 불가능하게끔 구현 (중복점프) (4-1)
4-2 플레이어가 이동 혹은 점프를 할 시 효과음이 재생되도록 구현 (4-2)
5. 플레이어 캐릭터는 마우스 포인트의 이동에 따라 시점이 변환되도록 구현 (5)
6. 플레이어 캐릭터의 이동을 카메라가 추적하도록 구현 (6)
7. 플레이어 캐릭터가 장애물을 피해 골라인으로 이동하다가 장외하여 맵 밖의 콜라이더에 충돌했을시 지나온 지점 중 특정 스폰 포인트에서 다시 스폰된다. (7)
8. 플레이어 캐릭터가 장애물들을 피해 골라인에 도달했을 시 게임 클리어 씬 으로 전환된다. (8)
...
2주차
1. <strike>게임 플레이 씬 진입시 메인 bgm이 재생된다. (3-1) 100%</strike>
...
4. 게임 플레이 씬 스테이지 밖에는 캐릭터의 장외를 판정하는 콜라이더 구현. (3-9)
