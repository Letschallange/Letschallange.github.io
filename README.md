...
2-2. 게임시작 버튼 클릭시 플레이 씬 으로 이동한다.
2-3  게임종료 버튼 클릭시 게임이 종료된다.
3. 게임 플레이 씬 에는 다양한 장애물, 스카이박스, 플레이어 캐릭터, 메인bgm, 배경 에셋(풀,나무),타이머 등이 배치되어있다.
3-1. 게임 플레이 씬 진입시 메인 bgm이 재생된다.
3-2. 게임 플레이 씬 진입시 플레이어 캐릭터가 시작지점에 스폰된다.
3-3.  게임 플레이 씬 진입시 시간이 얼마나 흘렀는지 알려주는 타이머가 가동된다.
3-4. 게임 플레이 씬 내에는 맑은 하늘의 스카이박스가 배치되있다.
3-5. 게임 플레이 씬 내에 풀,나무 등과 같은 배경 에셋이 분위기에 맞게끔 꾸며져있다.
3-6. 게임 플레이 씬 내에는 다양한 장애물들이 시작지점~골라인 까지 알맞게 배치되어있다.
3-7. 게임 플레이 씬 진입시 각각의 효과,특성을 지닌 장애물들이 가동된다.
3-8. 장애물의 종류에는 밟으면 날라가는 장애물, 굴러오는 장애물, 회전하는 장애물 등 다양한 방식의 장애물 구현.
3-9. 게임 플레이 씬 스테이지 밖에는 캐릭터의 장외를 판정하는 콜라이더 구현.
3-10. 게임 플레이 씬 스테이지 끝 에는 골라인 구현.
5. 플레이어 캐릭터는 w / a / s / d / spacebar 키를 통해 각각 전 좌 우 후 점프 를 할수 있게끔 구현
5-1 플레이어 캐릭터는 공중에서 한번 더 점프가 불가능하게끔 구현 (중복점프)
5-2 플레이어가 이동 혹은 점프를 할 시 효과음이 재생되도록 구현
